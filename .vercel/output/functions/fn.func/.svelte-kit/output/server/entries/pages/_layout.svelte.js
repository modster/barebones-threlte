import { d as get_store_value, c as create_ssr_component, e as escape, f as add_attribute, h as compute_slots, j as add_styles, v as validate_component } from "../../chunks/ssr.js";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return ` ${validate_component(AppShell, "AppShell").$$render(
    ...
    {},
    {
      ...
      sidebarLeft: () => {
        return ` <nav class="list-nav" data-svelte-h="svelte-10f0elz"><ul><li><a href="/">Home</a></li> <li><a href="/about">About</a></li></ul></nav>  `;
      },
      default: () => {
